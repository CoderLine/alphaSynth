...
class AlphaSynthJsGenerator 
{
	...
	function genClass( c : ClassType ) {
		...
		if( c.constructor != null ) {
            var ctor = c.constructor.get().expr;
			genConstructor(ctor);
        }
		else
			print("function() { }");
    ...
    function genConstructor( e : TypedExpr ) {
        print("function () { /* ctor */ }");
        print(Std.string(e));
    }
	...
	public static function use() {
		Compiler.setCustomJSGenerator(function(api) new AlphaSynthJsGenerator(api).generate());
	}
	#end
}