...
$hxExpose(as.AlphaSynthFlashApi, "as.AlphaSynth");
as.AlphaSynthFlashApi.__name__ = ["as","AlphaSynthFlashApi"];
as.AlphaSynthFlashApi.__interfaces__ = [as.IAlphaSynth];
as.AlphaSynthFlashApi.main = function() {
	as.AlphaSynthFlashApi.instance = new as.AlphaSynthFlashApi();
}
as.AlphaSynthFlashApi.init = function(asRoot,swfObjectRoot) {
	...
	if(swf) {
		...
		swf.embedSWF(asRoot + "alphaSynthFlashOnly.swf","alphaSynthContainer","1px","1px","11.4.0",swfObjectRoot + "expressInstall.swf",{ },{ },{ id : "AlphaSynth"});
		return true;
	} else {
