...
namespace AlphaSynth.Util
{
    public static class IOHelper
    {
        ...
        public static ushort ReadUInt16LE(this IReadable input)
        {
            ...
            return TypeUtils.ToUInt16((ch2 << 8) | (ch1 << 0));
        }
        ...
        public static short ReadInt16LE(this IReadable input)
        {
            ...
            return TypeUtils.ToInt16((ch2 << 8) | (ch1 << 0));
        }
        ...
        public static ushort ReadUInt16BE(this IReadable input)
        {
            ...
            return TypeUtils.ToUInt16((ch1 << 8) | (ch2 << 0));
        }
        ...
        public static short ReadInt16(this byte[] input, int index)
        {
            if (TypeUtils.IsLittleEndian)
            {
                return TypeUtils.ToInt16(input[index] | (input[index + 1] << 8));
            }
            else
            {
                return TypeUtils.ToInt16((input[index] << 8) | input[index + 1]);
            }
        }
    }
}
